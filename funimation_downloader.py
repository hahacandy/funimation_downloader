        ...
        while is_break == False:
            ...
            while try_idx < 5:
                ...
                if vtt_url != None and m3u8_url != None:
                    ...
                    cmd = 'ffmpeg -y -protocol_whitelist file,http,https,tcp,tls,crypto' + ' -i "' + save_path2 + m3u8_name + '" -vcodec copy -acodec copy ' + '-metadata creation_time="' + str(datetime.now().strftime('%Y-%m-%d %H:%M:%S')) + '"' + ' "' + save_path2 + video_name + '"'
